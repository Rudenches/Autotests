...
public class InvalidCdrFileGenerator {
    ...
    private static void generateTestDataWithIncorrectTime(BufferedWriter writer) throws IOException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            generateOutgoingCdr(writer,callerNumber,contactNumber,startTime,endTime);
            generateIncomingCdr(writer,callerNumber,contactNumber,startTime,endTime);
    ...
    private static void generateOutgoingCdr (BufferedWriter writer, String callerNumber, String contactNumber,
    ...
    private static void generateIncomingCdr (BufferedWriter writer, String callerNumber, String contactNumber,
                                                      LocalDateTime startTime, LocalDateTime endTime) throws IOException {
        CdrData outgoing = new CdrData();
